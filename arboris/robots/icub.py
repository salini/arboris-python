...
def get_shapes_data():
    ...
    'lf1'  : ['l_foot', (), transl(-.041,-.027,-.031)],
    'lf2'  : ['l_foot', (), transl(-.041, .027,-.031)],
    'lf3'  : ['l_foot', (), transl(-.041, .027, .099)],
    'lf4'  : ['l_foot', (), transl(-.041,-.027, .099)],
    'l_sole': ['l_foot', (), dot(transl(-.041, .0  , .034), dot(roty(-pi/2), rotx(-pi/2) ) )],

    'rf1'  : ['r_foot', (), transl(-.041,-.027, .031)],
    'rf2'  : ['r_foot', (), transl(-.041, .027, .031)],
    'rf3'  : ['r_foot', (), transl(-.041, .027,-.099)],
    'rf4'  : ['r_foot', (), transl(-.041,-.027,-.099)],
